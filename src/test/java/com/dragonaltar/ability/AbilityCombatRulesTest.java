...
class AbilityCombatRulesTest {
	...
	void scriptedFireAndReflectionDamageCannotDriveHuntProgress() {
		assertTrue(
				AbilityCombatRules.RevHuntTracker.acceptsDamage(AbilityCombatRules.CombatDamageSource.DIRECT_PLAYER));
		assertTrue(AbilityCombatRules.RevHuntTracker
				.acceptsDamage(AbilityCombatRules.CombatDamageSource.PLAYER_PROJECTILE));
		assertFalse(AbilityCombatRules.RevHuntTracker.acceptsDamage(AbilityCombatRules.CombatDamageSource.FIRE_TICK));
		assertFalse(AbilityCombatRules.RevHuntTracker
				.acceptsDamage(AbilityCombatRules.CombatDamageSource.SCRIPTED_ABILITY));
