...
public final class AkumasTrail extends ConfiguredAbility {
    public AkumasTrail(AbilityService service) {
        super(service, "akumas-trail", "<aqua>Akuma's Trail", AbilityCategory.MOVEMENT,
    ...
    @Override protected void activate(Player player) { service.activateAkumasTrail(player); }
}
