...
public enum DragonResonance {
    THERMAL_CONVERGENCE("thermal-convergence", "Thermal Convergence", Set.of(SoulIdentity.AKUMA, SoulIdentity.REV)),
    VOLCANIC_AEGIS("volcanic-aegis", "Volcanic Aegis", Set.of(SoulIdentity.REV, SoulIdentity.LAMARI)),
    GLACIAL_BASTION("glacial-bastion", "Glacial Bastion", Set.of(SoulIdentity.AKUMA, SoulIdentity.LAMARI)),
    DRAGON_TRINITY("dragon-trinity", "Dragon Trinity", Set.of(SoulIdentity.AKUMA, SoulIdentity.REV, SoulIdentity.LAMARI));
    ...
    public Set<SoulIdentity> souls(){return souls;}
