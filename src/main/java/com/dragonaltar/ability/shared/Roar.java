...
public final class Roar extends ConfiguredAbility {
    ...
    @Override protected int defaultEnergyCost() { return 35; }
    @Override protected int defaultCooldownSeconds() { return 25; }
    @Override protected void activate(Player player) { service.activateRoar(player); }
}
