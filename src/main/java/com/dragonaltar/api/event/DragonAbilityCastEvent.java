...
public final class DragonAbilityCastEvent extends DragonAltarCancellableEvent {
    private static final HandlerList HANDLERS=new HandlerList();
    private final Player player; private final String abilityId;
    public DragonAbilityCastEvent(Player player,String abilityId){this.player=player;this.abilityId=abilityId;}
