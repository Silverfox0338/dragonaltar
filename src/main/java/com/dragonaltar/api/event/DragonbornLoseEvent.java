...
public final class DragonbornLoseEvent extends DragonAltarEvent {
    private static final HandlerList HANDLERS=new HandlerList();
    private final UUID player; private final String soulId;
    public DragonbornLoseEvent(UUID player,String soulId){this.player=player;this.soulId=soulId;}
