...
public final class DragonSoulReserveEvent extends DragonAltarCancellableEvent {
    ...
    private final String soulId; private final UUID player;
    public DragonSoulReserveEvent(String soulId,UUID player){this.soulId=soulId;this.player=player;}
    public String soulId(){return soulId;} public UUID player(){return player;}
