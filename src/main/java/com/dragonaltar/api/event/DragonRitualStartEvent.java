...
public final class DragonRitualStartEvent extends DragonAltarCancellableEvent {
    private static final HandlerList HANDLERS=new HandlerList();
    private final Player player; private final String soulId;
    public DragonRitualStartEvent(Player player,String soulId){this.player=player;this.soulId=soulId;}
