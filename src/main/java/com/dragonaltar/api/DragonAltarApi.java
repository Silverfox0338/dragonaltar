...
public interface DragonAltarApi {
    ...
    /**
     * Registers an independent add-on. Registration must happen on the server thread.
     */
     ...
     * custody; this method now returns an empty result. Use {@link #soulInfo(String)}.
     */
    @Deprecated
    Optional<DragonSoul> soul(String id);
    /**
     * @deprecated raw soul access was removed to protect private administrative
     * custody; this method now returns an empty result. Use {@link #soulInfoOf(UUID)}.
     */
    @Deprecated
