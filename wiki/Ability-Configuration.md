...
This is the complete tuning reference for the shipped `abilities.yml` in DragonAltar 1.4.21. The [Abilities](Abilities) and [Resonances](Resonances) pages explain what players experience.
