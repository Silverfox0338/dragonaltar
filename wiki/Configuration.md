...
DragonAltar 1.4.23 ships six editable YAML files. Each has a `config-version`. Runtime state is stored separately under `plugins/DragonAltar/data` and uses `data-version`.
