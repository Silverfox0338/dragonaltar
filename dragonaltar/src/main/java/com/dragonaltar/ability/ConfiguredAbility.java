...
public abstract class ConfiguredAbility implements DragonAbility {
	...
	protected ConfiguredAbility(AbilityService service, String id, String fallbackName, AbilityCategory category,
			Set<SoulIdentity> souls, boolean ultimate) {
	...
	public final Component displayName() {
		return service.abilityName(id, fallbackName);
	}
	@Override
	...
	@Override
	public final Set<SoulIdentity> souls() {
		return souls;
	}
	@Override
