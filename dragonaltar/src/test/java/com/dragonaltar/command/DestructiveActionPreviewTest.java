...
final class DestructiveActionPreviewTest {
	...
	void rendersEveryRequiredSafetyFieldAndCommands() {
		String rendered = new DestructiveActionPreview("force remove", List.of("PlayerA"), List.of("Rev"),
				"Rev enters dormant/pending reincarnation.", "Unchanged", "A removal event is appended.",
				"Can be reassigned.").render("ABC234", 30);
